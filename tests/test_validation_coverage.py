...
from panelsplit.utils.validation import (
    check_periods, check_labels, get_index_or_col_from_df, check_cv, 
    check_fitted_estimators, check_method, _check_X_y
)
...
class TestValidationCoverage(unittest.TestCase):
    ...
    def test_check_cv_with_different_inputs(self):
        ...
        splits_list = [
            ...
            (np.array([True, True, True, False]), np.array([False, False, False, True]))
        ]
